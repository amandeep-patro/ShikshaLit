...
class _AlphabetsScreenState extends State<AlphabetsScreen>
  ...
  // Remove widget.section references since this is specifically for alphabets
  ...
  // Keep all methods from SectionScreen but modify _fetchItems
  ...
  // Keep all other methods from SectionScreen
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            // Modified question card for alphabets
                            Card(
                              elevation: 4,
