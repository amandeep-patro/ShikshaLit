...
class _RhymingWordsScreenState extends State<RhymingWordsScreen> {
  ...
  void _finishTest() async {
    ...
    await ScoresService.saveTestScore('rhyming', score);
      ...
      if (data != null && data['exercies'] is List) {
        ...
        if (mounted) {
          setState(() {
            ...
            hasError = true;
            errorMessage =
                'No rhyming exercises found. Please try again later.';
          });
        }
      }
    } catch (e) {
  ...
  void _checkAnswer(String selectedOption) {
    if (showResult || !mounted)
      return; // Don't allow selection during result animation

    Map<String, dynamic> currentExercise =
        rhymingExercises[currentExerciseIndex];
  ...
  Widget build(BuildContext context) {
    ...
    List<String> shuffledOptions =
        shuffledOptionsForExercises[currentExerciseIndex];
                  ...
                  child:
                      showResult
                          ? SingleChildScrollView(
                            // Make result view scrollable to avoid overflow
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Container(
