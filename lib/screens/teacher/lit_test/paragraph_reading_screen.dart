...
class _ParagraphReadingScreenState extends State<ParagraphReadingScreen>
      ...
      if (data != null && data['items'] is List) {
        setState(() {
          ...
          questions =
              (paragraphs..shuffle())
                  .take(3)
                  .toList(); // Only take 3 paragraphs as they are longer
  ...
  Future<void> _transcribeAudio() async {
    ...
    final url = Uri.parse(
      'https://api.deepgram.com/v1/listen?detect_language=true&diarize=false&punctuate=true&model=nova-2&filler_words=true&utterances=true',
    );
    ...
    try {
      ...
      if (jsonResponse['results'] != null) {
        ...
        final words =
            jsonResponse['results']['channels'][0]['alternatives'][0]['words'] ??
            [];
        ...
        double stutterPercentage =
            totalWords > 0 ? (fillerWordCount / totalWords) * 100 : 0;
  ...
  Future<void> _finishTest() async {
    // Calculate average score from reading percentages
    final score =
        readingPercentages.isEmpty
            ? 0
            : (readingPercentages.reduce((a, b) => a + b) /
                    readingPercentages.length)
                .round();

    // Save score using ScoresService
    await ScoresService.saveTestScore('reading', score);

    // Save completion status and detailed metrics
    ...
    await prefs.setString('reading-pauses', jsonEncode(pausesCounts));
    await prefs.setString('reading-stutters', jsonEncode(stutterPercentages));
      ...
      child: Scaffold(
        ...
        body:
            isLoading
                ...
                : SafeArea(
                  // Added SafeArea to prevent bottom overlay
                  child: Column(
                    children: [
                      // Progress bar
                      Container(
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            _buildStatCard(
                                              ...
                                              readingPercentages[currentQuestionIndex] >
                                                      75
                                                  ? Colors.green
                                                  : Colors.orange,
                                            ...
                                            _buildStatCard(
                                              ...
                                              stutterPercentages[currentQuestionIndex] <
                                                      5
                                                  ? Colors.green
                                                  : Colors.orange,
                                              Icons.repeat,
                                            ...
                                            Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                            ...
                                                            RichText(
                                                              text: TextSpan(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  TextSpan(
                                                                    text:
                                                                        '(${pause['duration'].toStringAsFixed(1)}s pause)',
                                                                    style: TextStyle(
                                                                      color:
                                                                          Colors
                                                                              .red,
                                                  ...
                                                  if (_pauseLocations.length >
                                                      5)
                                                    Text(
                                                      '+ ${_pauseLocations.length - 5} more pauses',
                                                    ),
                                                ],
                                              ),
                                            ),
                                            ...
                                            Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  if (_stutterLocations.length >
                                                      5)
                                                    Text(
                                                      '+ ${_stutterLocations.length - 5} more stutters/fillers',
                                                    ),
                                                ],
                                              ),
                                            ),
