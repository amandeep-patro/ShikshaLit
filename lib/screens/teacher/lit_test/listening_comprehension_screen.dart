...
class _ListeningComprehensionScreenState
      ...
      if (data != null && data['comprehensions'] is List) {
        ...
        for (var comp in rawComprehensions) {
          ...
          for (var questionMap in questionsRaw) {
            ...
            List<Map<String, dynamic>> shuffledOptions = List.from(
              parsedOptions,
            );
  ...
  Future<void> _finishTest() async {
    ...
    await ScoresService.saveTestScore('comprehension', score);
  ...
  Widget build(BuildContext context) {
    ...
    if (comprehensions.isEmpty) {
      return Scaffold(
        ...
        body: Center(child: Text('No comprehension exercises available')),
      );
    }

    Map<String, dynamic> currentComprehension =
        comprehensions[currentComprehensionIndex];
